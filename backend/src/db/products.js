const resolveBaseUrl = () => {
  ...
  const inferredBase = process.env.RENDER_EXTERNAL_URL;
  const baseUrl = explicitBase || inferredBase || 'http://127.0.0.1:3000';
...
export const products = [
  {
    ...
    price: 699.99,
    imageUrl: assetUrl('smartphone.jpg'),
    rating: 4.5
  },
  {
    id: '2',
  ...
  },
  {
    ...
    price: 199.99,
    imageUrl: assetUrl('headphones.jpg'),
    rating: 3
  },
  {
    id: '4',
